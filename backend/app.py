...
def video_submission_preview(pid:str,node_id:str):
    ...
    return {key:data.get(key) for key in ('video_ratio_selection','ratio','composition_mode','visual_style','prompt','reference_manifest','motion_reference','motion_warnings','planned_shot_duration','shot_duration','motion_compiler','generation_mode','dialogue_mode','voice_samples')}
