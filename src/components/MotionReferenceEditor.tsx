...
export function MotionReferenceEditor(props: Props) {
  ...
  const signature = JSON.stringify([props.shot, props.node?.data, props.document.videoDuration, props.document.videoReferenceMode, props.document.filmBible, props.assets.map(a => a.id)]);
