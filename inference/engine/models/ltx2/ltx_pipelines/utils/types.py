...
class PipelineComponents:
    ...
    def __init__(
        ...
        # ID-LoRA: optional reference audio for voice identity preservation
        # Set by ltx2.py when a voice reference is provided
        self.ref_audio_latent = None       # torch.Tensor [B, C, T_ref, F] or None
        self.ref_audio_positions = None    # torch.Tensor [B, 1, T_ref, 2] or None
        self.identity_guidance_scale = 0.0  # 0 = disabled (no ID-LoRA amplification)
