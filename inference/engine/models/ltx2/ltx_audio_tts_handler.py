...
def _get_scenema_download_def():
    ...
    ] + _require_seedvc().query_download_def(mode=seedvc.SEEDVC_MODE_SPEECH)
...
class family_handler:
    ...
    def query_supported_types():
        # Maestro fork divergence: upstream returns ["scenema_audio", "dramabox_audio"]
        ...
        # active for "scenema_audio" (Maestro's ScenemaAudioPipeline is
    ...
    def load_model(
        ...
        **kwargs,
        ...
        seedvc_model = _require_seedvc().get_model(dtype=torch.float16, mode=seedvc.SEEDVC_MODE_SPEECH)
