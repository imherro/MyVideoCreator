# Upstream WanGP Changelog (historical reference)

> **Note:** This is the changelog of [WanGP / Wan2GP](https://github.com/deepbeepmeep/Wan2GP),
> the upstream project Maestro's generation pipeline is built on. It is kept
> for reference when tracking upstream features. **Maestro's own changelog is
> at the repository root: [CHANGELOG.md](../../CHANGELOG.md).** The same goes
> for the other documents in this folder — they describe the upstream WanGP
> pipeline unless stated otherwise.
