...
def polish_prompts_third_pass(
    ...
    Args:
        ...
        source_language: Source-story language tag. Chinese sources keep all
            visible and generation prompt prose in Simplified Chinese.
    ...
    chinese_language_lock = ""
    if str(source_language or "").lower().startswith("zh"):
        chinese_language_lock = (
            "\nLANGUAGE LOCK — NON-NEGOTIABLE:\n"
            "The source story is Simplified Chinese. Output the complete prompt "
            "in Simplified Chinese, including visual description, actions, "
            "camera, lighting, and sound. Translate any English narrative prose "
            "in the input into Simplified Chinese. JSON labels and model names are "
            "not part of the output. Preserve quoted dialogue verbatim.\n"
        )
    ...
    _image_system_base = (
        ...
        "YOUR JOB:\n"
        + _image_lora_line +
        "- Preserve any explicit Chinese/East Asian casting, Chinese names, and Chinese cultural setting anchors already present in the input; never Westernize or remove them\n"
